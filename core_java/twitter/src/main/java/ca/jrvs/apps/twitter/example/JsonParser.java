...
public class JsonParser {
    ...
    public static String toJson(Company object, boolean prettyJson, boolean includeNullValues)
     ...
     public static <T> T toObjectFromJson(String json, Class<Company> clazz) throws IOException {
        ObjectMapper m = new ObjectMapper();
    ...
    public static void main(String[] args) throws IOException {
        ...
        String revert = toJson(company, true, false);
        logger.debug(revert);
    }
}
